...
const run = async () => {
  ...
  const data = await page.evaluate(() => {
    ...
    const cityReplacements = {"Singapore": "Singapore, Singapore", "Zürich": "Zurich", "Frankfurt": "Frankfurt am Main", "Bogotá": "Bogota", "Saint Petersburg": "St. Petersburg", "Hong Kong SAR": "Hong Kong", "Delhi": "New Delhi"}
